...
@Slf4j
@Component(MoneySavedEvent.INPUT_DLQ_BINDING_NAME)
@RequiredArgsConstructor
public class MoneySavedEventDLQSubscriber implements Consumer<MoneySavedEvent> {
    private final CreateMoneySavedMarkUseCase createMoneySavedMarkUseCase;

    @Override
    public void accept(final MoneySavedEvent event) {
        log.info("Retrying to create money saved mark. event = {}", event);
