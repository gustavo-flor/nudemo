...
@Slf4j
@Component(MoneyRescuedEvent.INPUT_DLQ_BINDING_NAME)
@RequiredArgsConstructor
public class MoneyRescuedEventDLQSubscriber implements Consumer<MoneyRescuedEvent> {
    ...
    public void accept(final MoneyRescuedEvent event) {
        log.info("Retrying to create money rescued mark. event = {}", event);
